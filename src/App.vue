        ...
        <div class="navbar-collapse collapse w-100 order-1 order-md-0 dual-collapse2">
            <div class="row">
                <div class="navbar col-4">
                    <img src="https://github.com/624235032/image01/blob/main/customer.png?raw=true" class="rounded mx-auto d-block" width="60px" />
                </div>
                <div class="navbar col text-left">
                    <span class="navbar-brand">IT<br />CustomerAPI</span>
                </div>
            </div>
        </div>
        ...
        <div class="collapse navbar-collapse" id="navbarColor01">
            ...
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <router-link class="nav-link" to="/">Customers <span class="sr-only">(current)</span></router-link> |
                </li>
                <li class="nav-item">
